"""
Fine-tunes a Google CANINE model for Hinglish text classification.

This script handles the entire workflow:
1. Loads the human-annotated dataset.
2. Prepares labels and tokenizes the text.
3. Sets up the CANINE model for sequence classification.
...
def main():
    ...
    # --- Save Artifacts ---
    metrics_path = METRICS_DIR / "canine_metrics.json"
